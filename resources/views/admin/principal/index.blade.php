...
<section class="body">
    ...
    <header class="header">
        <div class="logo-container">
            <a href="../" class="logo">
                {{--<img src="{{asset('/images/admin/logo.png')}}" height="35" alt="JSOFT Admin"/>--}}
                LPJJ
            </a>
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="{{asset('/images/admin/!sample-user.jpg')}}" alt="Joseph Doe Junior"
                                                 class="img-circle"/>
                                        </figure>
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="{{asset('/images/admin/!sample-user.jpg')}}" alt="Joseph Junior"
                                                 class="img-circle"/>
                                        </figure>
                                ...
                                <header class="panel-heading bg-primary">
                                    ...
                                    <div class="widget-profile-info">
                                        <div class="profile-picture">
                                            <img src="{{asset('/images/admin/!logged-user.jpg')}}">
                                        </div>
                                        <div class="profile-info">
                                            <h4 class="name text-semibold">Gabriel Cabral</h4>
                                            <h5 class="role">Administrador</h5>
                                    ...
                                    <ol class="tm-items">
                                        <li>
                                            <div class="tm-box">
                                                ...
                                                <p>
                                                    It's awesome when we find a good solution for our projects, JSOFT
