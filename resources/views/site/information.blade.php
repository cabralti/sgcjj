            ...
            <div class="row justify-content-center">
                    ...
                    <div class="single-latest-sermons">
                        <div class="sermons-content">
                            ...
                            <div class="sermons-thumbnail text-center">
                                <div class="card">
                                    <embed src="{{asset('uploads/[LPJJ] - Livro_De_Regras.pdf')}}" height="600" style="border: none;" type="application/pdf" class="hidden-xl-down" internalinstanceid="11">
                                </div>
                            </div>
                            <hr>
                            <div class="sermons-cata">
                                <a href="{{asset('uploads/[LPJJ] - Livro_De_Regras.pdf')}}" download data-toggle="tooltip" data-placement="top" title="Download">
                ...
                <div class="col-12">
                    <div class="single-latest-sermons mb-100">
                        <div class="sermons-content">
                            <h4 class="pb-0 mb-3"><i class="fa fa-balance-scale" aria-hidden="true"></i> Tabela de Pesos</h4>
                            ...
                            <hr>
                            <div class="sermons-cata">
                                <a href="{{asset('uploads/[LPJJ] - Tabela_De_Pesos.jpeg')}}" download data-toggle="tooltip" data-placement="top" title="Download">
                                    <i class="fa fa-cloud-download fa-2x" aria-hidden="true"></i>
                                </a>
                            </div>
                        </div>
